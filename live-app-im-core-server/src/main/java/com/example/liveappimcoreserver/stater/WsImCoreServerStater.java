...
import com.example.liveappimcoreserver.common.WebsocketEncoder;
import com.example.liveappimcoreserver.handler.Ws.WsImCoreServerHandler;
...
@Configuration
@RefreshScope
public class WsImCoreServerStater implements InitializingBean {
    private static final Logger LOGGER = LoggerFactory.getLogger(WsImCoreServerStater.class);
    //指定监听的端口
    ...
    @Resource
    private WsImCoreServerHandler wsImCoreServerHandler;
    @Resource
    ...
    public void startApplication() throws InterruptedException {
        ...
        bootstrap.childHandler(new ChannelInitializer<>() {
            ...
            protected void initChannel(Channel ch) throws Exception {
                ...
                ch.pipeline().addLast(wsImCoreServerHandler);
            }
        });
        //基于JVM的钩子函数去实现优雅关闭
